export default {
  ...
  playground: {
    title: '操练场',
    description: '像在工作台里一样调试模型、分组和请求参数',
    send: '发送',
    stop: '停止',
    clear: '清空会话',
    loading: '正在加载操练场数据...',
    inputPlaceholder: '请输入你的问题，或编辑上面的请求参数。',
    group: '分组',
    model: '模型',
    settings: '参数设置',
    debug: '调试面板',
    ...
    response: '响应结果',
    emptyTitle: '开始一段新的对话',
    emptyDescription: '选择分组和模型后即可发送请求，调试面板会显示完整请求和响应。',
    systemPrompt: '系统提示词',
    stream: '流式输出',
    temperature: '采样温度',
    topP: 'Top P 采样',
    ...
    seed: '随机种子',
    customRequestMode: '自定义请求体',
    customRequestBody: '请求体 JSON',
    imageMode: '图片模式',
    imageUrls: '图片链接',
    imageUrlPlaceholder: 'https://example.com/image.png',
    mode: '模式',
    chatMode: '聊天',
    chatModeDescription: '使用支持聊天的模型进行多轮对话和调试。',
    imageGenerationMode: '生图',
    imageSize: '图片尺寸',
    imageQuality: '图片质量',
    imageBackground: '背景',
    imageOutputFormat: '输出格式',
    imageModeDescription: '使用支持生图的模型生成图片。',
    generatingImage: '正在生成图片...',
    imageGenerated: '图片生成完成。',
    assistantThinking: '推理过程',
    copy: '复制',
    retry: '重试',
    user: '用户',
    assistant: '助手',
  ...
  auth: {
    ...
    usernameHint: '2-32 个字符，可使用中文、字母、数字和下划线',
    emailLabel: '邮箱',
    ...
    invalidUsername: '用户名需为 2-32 个字符，仅支持中文、字母、数字和下划线',
    invalidEmail: '请输入有效的邮箱地址',
  ...
  admin: {
    ...
    accounts: {
      ...
      fetchModels: '获取模型列表',
      fetchModelsLoading: '正在获取模型列表...',
      fetchModelsDialogTitle: '选择模型列表',
      fetchModelsSearch: '搜索已获取的模型...',
      fetchModelsSuccess: '已获取 {count} 个模型',
      fetchModelsFallbackWarning: '获取失败，已回退到本地模型列表',
      fetchModelsHintRemote: '以下为刚刚实时获取的模型列表。',
      fetchModelsHintStatic: '以下为当前平台提供的静态兼容模型列表。',
      fetchModelsHintFallback: '远端获取失败，当前展示的是本地回退模型列表。',
      fetchModelsNewGroup: '新获取的模型',
      fetchModelsExistingGroup: '已有的模型',
      fetchModelsSectionCount: '{count} 个模型',
      fetchModelsSelectAllProviders: '选择所有模型提供商',
      fetchModelsProviderCount: '{count} 个',
      fetchModelsEmptySection: '当前分组没有模型',
      fetchModelsSelectProvider: '全选提供商',
    ...
    settings: {
      ...
      features: {
        ...
        images2: {
          title: 'ChatGPT Images 2 生图',
          description: '配置用户侧 ChatGPT Images 2 生图页面的文案、目标分组、模型和单次价格。',
          enabled: '启用 Images 2 页面',
          enabledHint: '关闭后页面不可用，但你仍可保留自定义菜单配置。',
          pageTitle: '页面标题',
          pageSubtitle: '页面副标题',
          badgeText: '角标文案',
          groupName: '目标分组名',
          modelName: '模型名称',
          pricePerImage: '单次价格（USD）',
          maxAttachments: '参考图最大数量',
          rechargePath: '充值跳转路径',
          noticeText: '页面提示文本',
          promoBannerEnabled: '启用顶部广告横幅',
          promoBannerTitle: '广告标题',
          promoBannerText: '广告正文',
          promoBannerCta: '广告按钮文案',
        },
      },
  ...
  images2: {
    ...
    sizeLabel: '图片尺寸',
    sizeSquare: '方图 1:1',
    sizeLandscape: '横图 3:2',
    sizePortrait: '竖图 2:3',
    sizeFollowReference: '跟随参考图比例',
    sizeFollowReferenceBody: '当前第一张参考图尺寸约为 {width} × {height}，比例约 {ratio}:1。重新生成时会优先沿用这张参考图的比例。',
    sizeFollowReferenceBodyUnknown: '重新生成时会优先沿用第一张参考图的原始比例。',
    generate: '开始生图',
    regenerate: '重新生成',
    edit: '修改图片',
    editCurrent: '编辑当前图片',
    ...
    attachmentsHint: '参考图会和提示词一起参与下一次生成；点击“编辑当前图片”会先把当前结果加入参考图列表。',
    attachmentsMeta: '仅支持图片，最多 {count} 张。',
    uploadAttachments: '上传参考图',
    removeAttachment: '移除参考图',
    attachmentsOnlyImages: '只能上传图片文件。',
    attachmentsReadFailed: '读取图片失败，请重新上传。',
    attachmentsLimitError: '最多只能上传 {count} 张参考图。',
    attachmentsCurrentResultLimitError: '参考图已满，最多 {count} 张。请先删除一张参考图，再添加当前图片。',
    attachmentPreviewAlt: '参考图 {index}',
    currentResultBadge: '当前结果图',
    currentResultAlt: '当前结果图',
    editPreserveAspectTitle: '跟随参考图时将保留第一张参考图比例',
    editPreserveAspectBody: '第一张参考图尺寸约为 {width} × {height}，比例约 {ratio}:1。生成时会优先沿用这个比例。',
    editPreserveAspectBodyUnknown: '选择跟随参考图比例时，会优先保留第一张参考图的原始比例。',
    editHint: '',
    resultEditHint: '想继续细化这张图的话，直接调整提示词后点击“基于当前图编辑”就行，系统会把当前图片和新提示词一起提交。',
    resultActionHintRegenerateLabel: '生成图片：',
    resultActionHintRegenerateBody: '使用当前提示词和参考图列表生成。没有参考图时，会从文本重新生成。',
    resultActionHintEditLabel: '编辑当前图片：',
    resultActionHintEditBody: '先把当前结果加入参考图列表，再点击生成图片继续修改；加入后可随时删除。',
    generating: '生成中...',
    newImage: '新图片',
    ...
    rechargeHint: '当前余额不足以支付一次生图，请先充值。',
    resultTitle: '生成结果',
    download: '下载图片',
    saveImage: '保存图片',
    loadingHint: '正在生成，约1-2分钟...',
    empty: '输入提示词后，生成结果会显示在这里。',
    generateFailed: '图片生成失败，请稍后重试。',
    defaultNotice: '图片不会长期保存，请及时下载保存。',
  },
