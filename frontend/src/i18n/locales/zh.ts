export default {
  ...
  images2: {
    ...
    resultActionHintRegenerateBody: '忽略当前图片，按提示词重新出图。',
    resultActionHintEditLabel: '编辑当前图片 — ',
    resultActionHintEditBody: '在这张图上继续修改。',
    generating: '生成中...',
    newImage: '新图片',
    ...
    download: '下载图片',
    saveImage: '保存图片',
    loadingHint: '正在生成，请稍候片刻。',
    empty: '输入提示词后，生成结果会显示在这里。',
    generateFailed: '图片生成失败，请稍后重试。',
    generateSuccessToast: '生成成功！想要调整、美化这张图片？修改文案后，点「编辑当前图片」就能直接二次修图。',
