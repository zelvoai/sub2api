export default {
  ...
  images2: {
    ...
    sizeLabel: '图片尺寸',
    sizeSquare: '方图 1024x1024',
    sizeLandscape: '横图 1536x1024',
    sizePortrait: '竖图 1024x1536',
    generate: '开始生图',
    edit: '修改图片',
    editCurrent: '基于当前图编辑',
    editHint: '当前已选中一张生成图。再次点击主按钮会带上这张图继续编辑；点击“新建图片”会只用提示词重新生成。',
    resultEditHint: '想继续改这张图，可以调整提示词并点击“基于当前图编辑”，系统会把当前图片和提示词一起提交。',
    generating: '生成中...',
    newImage: '新建图片',
    goRecharge: '去充值 👉',
    tipsTitle: '创作提示',
