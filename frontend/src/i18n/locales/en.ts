export default {
  ...
  images2: {
    ...
    resultActionHintRegenerateBody: 'Ignores the current image and creates a new one from the prompt.',
    resultActionHintEditLabel: 'Edit current image: ',
    resultActionHintEditBody: 'Continues editing from the image you already have.',
    generating: 'Generating...',
    newImage: 'New image',
    ...
    generateSuccessToast: 'Generated successfully! Want to refine or beautify this image? Update the prompt and click "Edit current image" to continue editing directly.',
