export default {
  ...
  images2: {
    ...
    currentResultBadge: 'Current edit image',
    currentResultAlt: 'Current result image',
    editPreserveAspectTitle: 'Editing keeps the original image aspect ratio',
    editPreserveAspectBody: 'The current result image is about {width} × {height}, with an aspect ratio of about {ratio}:1. Editing will try to keep that ratio.',
    editPreserveAspectBodyUnknown: 'When you edit the current image, we will try to keep its original aspect ratio instead of forcing one of the fixed size options below.',
    editHint: '',
    ...
    resultActionHintRegenerateLabel: 'Regenerate: ',
    resultActionHintRegenerateBody: 'Ignores the current result image, creates a new one from the prompt, and uses your reference images as guidance.',
    resultActionHintEditLabel: 'Edit current image: ',
    resultActionHintEditBody: 'Continues editing the current result image and also uses your reference images as guidance.',
    generating: 'Generating...',
    newImage: 'New image',
