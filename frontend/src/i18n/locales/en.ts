export default {
  ...
  playground: {
    title: 'Playground',
    description: 'Experiment with models, groups, and request parameters in one workspace.',
    send: 'Send',
    stop: 'Stop',
    clear: 'Clear Conversation',
    loading: 'Loading playground data...',
    inputPlaceholder: 'Ask something here, or adjust the request parameters first.',
    group: 'Group',
    model: 'Model',
    settings: 'Settings',
    debug: 'Debug Panel',
    ...
    emptyDescription: 'Choose a group and model, then send a request. The debug panel will show the full request and response.',
    ...
    seed: 'Seed',
    customRequestMode: 'Custom Request Body',
    customRequestBody: 'Request Body JSON',
    imageMode: 'Image Mode',
    imageUrls: 'Image URLs',
    imageUrlPlaceholder: 'https://example.com/image.png',
    mode: 'Mode',
    chatMode: 'Chat',
    chatModeDescription: 'Use chat-capable models for multi-turn conversation and debugging.',
    imageGenerationMode: 'Image Generation',
    imageSize: 'Image Size',
    imageQuality: 'Image Quality',
    imageBackground: 'Background',
    imageOutputFormat: 'Output Format',
    imageModeDescription: 'Generate images with models that support image generation.',
  ...
  auth: {
    ...
    usernameRegister: 'Username Sign Up',
    emailRegister: 'Email Sign Up',
    usernameLabel: 'Username',
    usernamePlaceholder: 'Enter your username',
    usernameHint: '2-32 characters; Chinese, letters, numbers, and underscores are allowed',
    emailLabel: 'Email',
    ...
    invalidUsername: 'Username must be 2-32 characters and only contain Chinese, letters, numbers, or underscores',
    invalidEmail: 'Please enter a valid email address',
  ...
  admin: {
    ...
    accounts: {
      ...
      fetchModelsLoading: 'Fetching model list...',
      fetchModelsDialogTitle: 'Choose models',
      fetchModelsSearch: 'Search fetched models...',
      fetchModelsSuccess: 'Fetched {count} models',
      fetchModelsFallbackWarning: 'Fetch failed, switched to the local model list',
      fetchModelsHintRemote: 'These models were fetched from the provider just now.',
      fetchModelsHintStatic: 'These models come from the current platform\'s static compatibility list.',
      fetchModelsHintFallback: 'Remote fetch failed, so the local fallback model list is shown.',
      fetchModelsNewGroup: 'Newly fetched models',
      fetchModelsExistingGroup: 'Existing models',
      fetchModelsSectionCount: '{count} models',
      fetchModelsSelectAllProviders: 'Select all providers',
      fetchModelsProviderCount: '{count} items',
      fetchModelsEmptySection: 'No models in this section',
      fetchModelsSelectProvider: 'Select provider',
    ...
    settings: {
      ...
      features: {
        ...
        images2: {
          ...
          description: 'Configure the user-facing ChatGPT Images 2 page copy, target group, model, and fixed per-image price.',
          enabled: 'Enable Images 2 page',
          enabledHint: 'When off, the page becomes unavailable even if a custom menu item still exists.',
          pageTitle: 'Page title',
          pageSubtitle: 'Page subtitle',
          badgeText: 'Badge text',
          groupName: 'Target group name',
          modelName: 'Model name',
          pricePerImage: 'Price per image (USD)',
          maxAttachments: 'Max reference images',
          rechargePath: 'Recharge path',
          noticeText: 'Notice text',
          promoBannerEnabled: 'Enable top promo banner',
          promoBannerTitle: 'Promo title',
          promoBannerText: 'Promo text',
          promoBannerCta: 'Promo CTA',
        },
      },
  ...
  images2: {
    ...
    sizeLandscape: 'Landscape 3:2',
    sizePortrait: 'Portrait 2:3',
    sizeFollowReference: 'Follow reference ratio',
    sizeFollowReferenceBody: 'The first reference image is about {width} × {height}, with an aspect ratio of about {ratio}:1. New generation will try to keep that reference ratio.',
    sizeFollowReferenceBodyUnknown: 'New generation will try to keep the first reference image aspect ratio.',
    ...
    attachmentsHint: 'Reference images are sent with your prompt on the next generation. Click "Edit current image" to add the current result here first.',
    attachmentsMeta: 'Images only, up to {count} files.',
    uploadAttachments: 'Upload reference images',
    removeAttachment: 'Remove reference image',
    attachmentsOnlyImages: 'Only image files can be uploaded.',
    attachmentsReadFailed: 'Failed to read the image. Please try again.',
    attachmentsLimitError: 'You can upload up to {count} reference images.',
    attachmentsCurrentResultLimitError: 'The reference list is full. Remove one image before adding the current result. Limit: {count}.',
    attachmentPreviewAlt: 'Reference image {index}',
    currentResultBadge: 'Current result',
    currentResultAlt: 'Current result image',
    editPreserveAspectTitle: 'Following references keeps the first reference aspect ratio',
    editPreserveAspectBody: 'The first reference image is about {width} × {height}, with an aspect ratio of about {ratio}:1. Generation will try to keep that ratio.',
    editPreserveAspectBodyUnknown: 'When following the reference ratio, generation will try to keep the first reference image aspect ratio.',
    editHint: '',
    resultEditHint: 'Want to keep refining this image? Update the prompt and click "Edit current image". We will submit the current image together with your new prompt.',
    resultActionHintRegenerateLabel: 'Generate image: ',
    resultActionHintRegenerateBody: 'Uses the current prompt and reference image list. With no references, it starts fresh from text.',
    resultActionHintEditLabel: 'Edit current image: ',
    resultActionHintEditBody: 'Adds the current result to the reference list first. Then click Generate image to continue editing; you can remove it anytime.',
    generating: 'Generating...',
    newImage: 'New image',
    rechargePrimary: 'Recharge',
    goRecharge: 'Recharge ->',
    ...
    rechargeHint: 'Your balance is not enough for one image. Please recharge first.',
    resultTitle: 'Result',
    download: 'Download',
    saveImage: 'Save image',
    loadingHint: 'Generating your image with a premium render pipeline. Please wait a moment.',
    empty: 'Your generated image will appear here after you submit a prompt.',
    generateFailed: 'Failed to generate image. Please try again later.',
    defaultNotice: 'Images are not stored long-term. Please download them in time.',
  },
