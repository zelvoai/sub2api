export default {
  ...
  images2: {
    ...
    sizeLandscape: 'Landscape 1536x1024',
    sizePortrait: 'Portrait 1024x1536',
    generate: 'Generate image',
    edit: 'Edit image',
    editCurrent: 'Edit current image',
    editHint: 'A generated image is selected. The next request will use it as the source image. Use "New image" to start from text only.',
    resultEditHint: 'Want to refine this image? Update the prompt and click "Edit current image"; the current image will be sent with your prompt.',
    generating: 'Generating...',
    newImage: 'New image',
    goRecharge: 'Recharge ->',
